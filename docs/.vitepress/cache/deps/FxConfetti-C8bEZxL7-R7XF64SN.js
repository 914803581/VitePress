...
// node_modules/@fuxishi/vitepress-theme/dist/chunk/FxConfetti-C8bEZxL7.js
var i = defineComponent({
  __name: "FxConfetti",
  props: { confetti: { type: [Boolean, Object] } },
  setup(e) {
    let i2 = e, a = typeof i2.confetti == "object" ? i2.confetti : {}, o = a.shape || "star", s = a.secondary !== false, c = a.shapes ? Array.isArray(a.shapes) ? a.shapes : [a.shapes] : null, l = [], u = [];
    function d(e2, t, n, i3 = "circle") {
      let a2 = () => {
      ...
      u.push(setTimeout(a2, 0)), u.push(setTimeout(a2, 50)), u.push(setTimeout(a2, 100));
    }
    let f = (e2, t) => d(e2, t, {
      spread: 360,
      ticks: 50,
    ...
    function h(e2) {
      let t = e2.clientX / window.innerWidth, n = e2.clientY / window.innerHeight;
      l.length > 0 ? m(t, n) : o === "colored-paper" ? p(t, n) : f(t, n);
    }
    return onMounted(() => {
      c && (l = c.map((e2) => confetti_module_default.shapeFromText({
        text: e2,
        scalar: 2
...
//# sourceMappingURL=FxConfetti-C8bEZxL7-R7XF64SN.js.map
