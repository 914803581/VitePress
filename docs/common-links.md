...
* https://github.com/jgraph/drawio/releases/tag/v30.0.0
* https://github.com/jgraph/drawio-desktop/releases/tag/v30.0.0
* https://github.com/jgraph/drawio-desktop/releases/
* https://github.com/jgraph/drawio-desktop/releases/latest
* https://github.com/jgraph/drawio-desktop/releases/download/v30.0.0/draw.io-30.0.0-windows.zip
* https://github.com/jgraph/drawio-desktop/releases/download/v30.0.0/draw.io-30.0.0.msi
* https://github.com/jgraph/drawio-desktop/releases/download/v30.0.0/draw.io-30.0.0-windows-installer.exe
...
* https://github.com/elastic/elasticsearch/releases?page=1
...
* https://adoptium.net/
* https://adoptium.net/zh-CN/temurin/releases?version=8\&os=any\&arch=any
* https://github.com/adoptium/temurin8-binaries/releases/download/jdk8u492-b09/OpenJDK8U-jdk\_x64\_windows\_hotspot\_8u492b09.zip



### Tomcat

* https://archive.apache.org/dist/tomcat/tomcat-6/v6.0.9/bin/apache-tomcat-6.0.9.zip
